...
do{
    ...
    console.log("\nCleitinho possui um kit GNV em seu carro, para poder obter lucro em suas viagens?\n");
    ...
    console.log('O jovem Cleitinho consegue fazer manuntenção mecânica em seu carro periodicamente para não ficar no prego\n dentro de uma favela perigosa?\n');
    respostaHero = prompt('Responta com "sim" ou "nao": ');
    console.clear();
    ...
    console.log('Nosso guerreiro conduz o seu veículo de forma ágil e eficaz possibilitando realizar um maior número de viagens\n durante o dia, evitando ficar preso em engarafamentos?\n')
    respostaHero = prompt('Responta com "sim" ou "nao": ');
    console.clear(); 
    ...
    console.log('Por fim, Cleitinho consegue manter o veículo limpo, ser educado e solícito para/com os passageiros\n possibilitando, ocasionalmente, garantir uma gorjetinha marota?\n')
    respostaHero = prompt('Responta com "sim" ou "nao": ');
    console.clear(); 
